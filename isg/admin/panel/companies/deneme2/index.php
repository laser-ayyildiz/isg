              ...
              <div class="modal-body">
                <div class="row col-12">
                  ...
                  <select name="new_report" id="new_report" class="form-control" required>
                    ...
                    <option value"icindekiler">İçindekiler+</option>
                    <option value="yangın">Yangın Tatbikatı Katılım Föyü+</option>
                    ...
                    <optgroup label="Risk Analizi">
                      <option value="risk_analizi_amac">Risk Analizi Amaç</option>
