          ...
          <div class="card-body">
            <div class="row align-items-center no-gutters">
              <div class="col mr-2">
                ...
                <?php
                $isletme_say = $pdo->query('SELECT COUNT(*) FROM `coop_companies` WHERE `change` = 1 AND `deleted` = 0')->fetchColumn();
                  ?>
        ...
        <div class="card shadow-lg border-left-success py-2">
          <div class="card-body">
            <div class="row align-items-center no-gutters">
              <div class="col mr-2">
                <?php
                  $calisan_say = $pdo->query('SELECT COUNT(*) FROM `coop_workers` WHERE `deleted` = 0')->fetchColumn();
                ?>
    ...
    <div class="row">
      <div class="col-lg-7 col-xl-8">
        <div class="card shadow-lg mb-4">
          ...
          <?php
                    $sorgu=$pdo->prepare("SELECT MONTH(contract_date) as month FROM coop_companies WHERE `change` = 1 AND `deleted` = 0");
                    $sorgu->execute();
      ...
      <div class="col-lg-5 col-xl-4">
        <div class="card shadow-lg mb-4">
          ...
          <div class="card-body">
            <?php
                      $plot=$pdo->prepare("SELECT comp_type as type FROM coop_companies WHERE `change` = 1 AND `deleted` = 0");
                      $plot->execute();
    ...
    <div class="row">
      <div class="col-lg-6 mb-4">
        <div class="card shadow-lg mb-4">
          ...
          <div class="card-body">
            <?php
              $toplam = $pdo->query("SELECT COUNT(*) FROM `coop_companies` WHERE `change` = '1' AND `deleted` = 0")->fetchColumn();
              $cok_tehlikeli = $pdo->query("SELECT COUNT(*) FROM `coop_companies` WHERE `danger_type` = 3 AND `deleted` = 0")->fetchColumn();
              $orta_tehlikeli = $pdo->query("SELECT COUNT(*) FROM `coop_companies` WHERE `danger_type` = 2 AND `deleted` = 0")->fetchColumn();
              $az_tehlikeli = $pdo->query("SELECT COUNT(*) FROM `coop_companies` WHERE `danger_type` = 1 AND `deleted` = 0")->fetchColumn();
