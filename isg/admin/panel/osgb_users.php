...
if (isset($_POST['kayıt'])) {
    ...
    if ($row['num'] > 0) {
      ...
      <?php
        ...
        ?>
      <div class="alert alert-danger alert-dismissible fade show" style=" margin-bottom: 0 !important;" role="alert">
        <strong>Bu TC Kimlik Numarası ile kayıtlı çalışan bulunmaktadır!</strong>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close" padding="auto">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <?php
        ...
        if ($result) {
          ...
          <?php
              ...
              if ($user_type == "İsg Uzmanı A" || $user_type == "İsg Uzmanı B" || $user_type == "İsg Uzmanı C") {
                  $user_auth = 0;
                            ...
                            <div class="col-sm-6">
                              ...
                              <select class="form-control" placeholder="Kullanıcı Türünü seçin" list="user_type" name="user_type" required>
                                ...
                                <optgroup label="İsg Uzmanı">
                                  <option value="İsg Uzmanı A">İsg Uzmanı A</option>
                                  <option value="İsg Uzmanı B">İsg Uzmanı B</option>
                                  <option value="İsg Uzmanı C">İsg Uzmanı C</option>
                                </optgroup>
